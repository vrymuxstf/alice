...
// You may execute this function to renderer with the UI and understand what it does.
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        if (ImGui::BeginMenu("Examples"))
        {
            ...
            ImGui::MenuItem("Property renderer", NULL, &show_app_property_editor);
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Trees"))
    {
        ...
        if (ImGui::TreeNode("Advanced, with Selectable nodes"))
        {
            ...
            //  You may retain selection state inside or outside your entities in whatever format you see fit.
    ...
    if (ImGui::TreeNode("Selectables"))
    {
        ...
        // and not necessarily inside a bool value (e.g. in flags within entities, as an external list, etc).
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        ImGui::SeparatorText("Inline color renderer");
...
static void ShowDemoWindowTables()
{
    ...
    // This section is mostly useful to renderer with combining certain flags or settings with each others.
...
// Demonstrate create a simple property renderer.
// This demo is a bit lackluster nowadays, would be nice to improve.
static void ShowExampleAppPropertyEditor(bool* p_open)
{
    ImGui::SetNextWindowSize(ImVec2(430, 450), ImGuiCond_FirstUseEver);
    if (!ImGui::Begin("Example: Property renderer", p_open))
    {
        ImGui::End();
        return;
    }
    ...
    HelpMarker(
        "This example shows how you may implement a property renderer using two columns.\n"
        "All entities/fields data are dummies here.\n");
    ...
    if (ImGui::BeginTable("##split", 2, ImGuiTableFlags_BordersOuter | ImGuiTableFlags_Resizable | ImGuiTableFlags_ScrollY))
    {
        ...
        // Iterate placeholder entities (all the same data)
